...
export function scoreColor(score) {
  ...
  if (score >= 65) return { text: '#8B5CF6', bg: '#EDE9FE', border: '#DDD6FE', label: 'Good' }
...
export function glucoseColor(value) {
  if (value < 70)               return { text: '#5B21B6', bg: '#EDE9FE', label: 'Low' }
...
export function todColor(key) {
  const map = {
    ...
    evening:   { fill: '#8B5CF6', light: '#EDE9FE', label: 'Evening' },
    night:     { fill: '#8B5CF6', light: '#EDE9FE', label: 'Night' },
  }
