...
export function getEvidenceLabel(evidence) {
  const map = {
    ...
    moderate: { label: 'Moderate Evidence', color: '#8B5CF6' },
...
export function getRatingColor(rating) {
  const map = {
    ...
    good:      { text: '#5B21B6', bg: '#EDE9FE', border: '#DDD6FE' },
